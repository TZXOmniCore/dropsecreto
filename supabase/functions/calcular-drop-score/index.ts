...
//
// Mantém o upsert único por lote (evita N updates separados) e adiciona
// um laço com orçamento de tempo pra drenar mais de um lote de 200 numa
// mesma execução quando tiver bastante pendente acumulado — sem isso,
// só o primeiro lote de 200 seria processado por execução.
// ============================================================
