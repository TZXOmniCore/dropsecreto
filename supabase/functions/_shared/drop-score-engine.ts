...
//
// IMPORTANTE: este arquivo é importado pelo frontend (Next.js/webpack),
// então NUNCA pode ter import de supabase-js, createClient, Deno.serve ou
// qualquer coisa de rede/banco aqui dentro — só cálculo puro. Isso foi o
// que quebrou o build antes: alguém colou o conteúdo da Edge Function
// inteira aqui por engano.
// ============================================================
